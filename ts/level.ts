        ...
        for (var y = 0; y < Globals.NumberOfTilesY; y++) {
            for (var x = 0; x < Globals.NumberOfTilesX; x++) {
                ...
                switch (id) {
                    ...
                    case '#':
                        this.map[x][y] = TileType.Brick;
                        break;
                    case '@':
                        this.map[x][y] = TileType.Solid;
                        break;
                    case 'H':
                        this.map[x][y] = TileType.Ladder;
                        break;
                    case '-':
                        this.map[x][y] = TileType.Bar;
                        break;
                    case 'S':
                        this.map[x][y] = TileType.EscapeLadder;
                        break;
                    case 'X':
                        this.map[x][y] = TileType.Trap;
                        break;
                    default:
                        console.log("Unknown map character: " + id);
                }
            }
        }
    }
